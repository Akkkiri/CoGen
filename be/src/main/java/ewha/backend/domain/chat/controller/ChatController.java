...
// import com.ewha.back.domain.chat.service.RoomService;
...
// 		List<ChatMessageDto.LastChatResponse> responses = chatMessageMapper.lastChatsToResponses(chatMessageList,
// 			userId);
//
// 		return new ResponseEntity<>(
...
// 	 */
// 	@GetMapping("/room")
// 	public ResponseEntity<Long> createOrGet(@ModelAttribute @Valid ChatRoomDto.Request request) {
//
// 		Long response = roomService.getOrCreate(request);
//
