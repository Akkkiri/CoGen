...
public class NotificationControllerRestDocs {
	...
	void subscribeTest() throws Exception {
		...
		ResultActions actions =
			mockMvc.perform(
				RestDocumentationRequestBuilders.get("/api/subscribe")
	...
	void getMyNotificationTest() throws Exception {
		...
		ResultActions actions =
			mockMvc.perform(
				RestDocumentationRequestBuilders.get("/api/notifications/{notification_id}", notificationId)
					.accept(MediaType.APPLICATION_JSON)
			);
	...
	void checkIfNotReadNotificationsTest() throws Exception {
		...
		ResultActions actions =
			mockMvc.perform(
				RestDocumentationRequestBuilders.get("/api/notifications/check")
					.accept(MediaType.APPLICATION_JSON)
			);
	...
	void deleteNotificationTest() throws Exception {
		...
		mockMvc.perform(
				RestDocumentationRequestBuilders.delete("/api/notifications/{notification_id}/delete", notificationId)
			)
	...
	void deleteAllMyNotificationsTest() throws Exception {
		...
		mockMvc.perform(
				RestDocumentationRequestBuilders.delete("/api/notifications/delete")
			)
			.andExpect(status().isNoContent())
			.andDo(
				document(
