			...
			.andDo(document(
				...
				responseFields(
					List.of(
						...
						fieldWithPath(".userInfo.hashcode").type(JsonFieldType.STRING).description("사용자 해시코드"),
			...
			.andDo(document(
				...
				responseFields(
					List.of(
						...
						fieldWithPath(".data.[].userInfo.hashcode").type(JsonFieldType.STRING).description("사용자 해시코드"),
