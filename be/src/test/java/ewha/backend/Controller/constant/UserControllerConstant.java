...
// 			.build();
//
// 	public static final UserDto.Verify VERIFY_REJECT_DTO =
// 		UserDto.Verify.builder()
// 			.userId("아이디")
// 			.nickname("닉네임")
// 			.password("12345678a!")
// 			.build();
//
// 	public static final UserDto.VerifyResponse VERIFY_RESPONSE_DTO =
// 		UserDto.VerifyResponse.builder()
// 			.status(String.valueOf(ExceptionCode.USER_ID_NOT_VALID.getStatus()))
// 			.message(ExceptionCode.USER_ID_NOT_VALID.getMessage())
// 			.field("userId")
// 			.rejectedValue("아이디")
// 			.reason("6~12자의 영문, 숫자만 사용 가능합니다.")
// 			.build();
//
// 	public static final List<UserDto.VerifyResponse> VERIFY_RESPONSE_LIST =
// 		List.of(VERIFY_RESPONSE_DTO);
//
